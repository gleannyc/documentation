...
![image](/product_updates/transpose-pink.gif){alt="An animated gif of someone going to the control panel in Glean flipping on the transpose table feature", style="max-width:650px;"}
...
![image](/product_updates/resourcedescription.png){alt="Image of user updating a resource description on a Glean chart", style="max-width:650px;"}
