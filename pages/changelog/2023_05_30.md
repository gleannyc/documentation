...
![image](/product_updates/230530_refreshedcontrolpanel.gif){alt="Animation of user navigating between controls, documentation and code editor", style="max-width:650px;"}
...
![image](/product_updates/230530_dashboardexplorationlinks.png){alt="User hovering over a chip component saying exploring", style="max-width:650px;"}
...
![image](/product_updates/230530_publiclinksharing.png){alt="Illustration of UI modal with share options", style="max-width:650px;"}
