...
explore data. You can use [roles](/project-management/users-and-permissions) to
...
of your team to edit data models. See [Data Modeling Best Practices](/data-modeling/data-modeling-best-practices)
...
4. Fill out the form and select the submit button: `Add User`
   ...
   - **Email:** Email to send the invite to. Projects can be setup to only allow
     ...
     `@yourcompany.com`).
   - **Full Name:** User's display name. They can change this themselves at any
     time.
...
Glean uses role based access control to allow users to do specific actions
within Glean. You can assign default roles, configure data access and limit
which actions specific users can take inside of Glean.
...
5. To edit a permission, again click on the pencil `✏️` icon to edit a
   permission rule
6. Here you can modify the permissions and resources associated with the
   permissions
