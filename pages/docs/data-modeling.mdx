...
See [Add Data Model](/data-modeling/add-data-model) to see how to setup your first data models.

**Editing a data model**

1. Select the [More](/visualizing-data/Chart-Menu) button on the top right-hand of the chart.
