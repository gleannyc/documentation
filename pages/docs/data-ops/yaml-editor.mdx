...
The editor allows you to easily iterate on Glean resources as code and see
changes in realtime. You can save your changes and explore via the application
as usual while the YAML editor is enabled. Configs can also be copied directly
from the editor into future data ops builds.
...
![](/yaml-editor/select-explore.png)
...
[Saved View Config Schema](/data-ops/config-schema/Saved-View) for how to format
your config files in the YAML editor.

![](/yaml-editor/explore.png)
