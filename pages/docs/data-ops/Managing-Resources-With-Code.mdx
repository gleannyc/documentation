...
- [Data Models](/data-ops/config-schema/Data-Model)
- [Saved Views](/data-ops/config-schema/Saved-View)
- [Dashboards](/data-ops/config-schema/Dashboard)
- [Color Palettes](/data-ops/config-schema/Color-Palette)
- [Homepage Launchpad](/data-ops/config-schema/Homepage-Launchpad)
...
update an existing resource with that [GRN](/data-ops/GRNs), instead of creating a
new resource.
